...
class TweetApiTests(TestCase):
    ...
    def test_retrieve(self):
        ...
        # tweet contains the user's nickname and avatar
    ...
    def test_create_with_files(self):
        ...
        # 上传单个文件
        # content需要时一个bytes类型，所以用str.encode转换一下
